...
train_dataset=Custom_Dataset_Marian(train_data[:10],model,token)
val_dataset=Custom_Dataset_Marian(val_data[:10],model,token)
test_dataset=Custom_Dataset_Marian(test_data[:10],model,token)
...
file_name="MARIANMT_schedule"
train_loss,bleu_sc,meteor_sc,rouge_sc,directory=training(3,model,'Encoder',train_loader,optimizer,4,file_name,val_loader)
